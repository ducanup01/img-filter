...
folder_path = "/home/ducanup01/projects/gaussian/real_image"  # Replace with your folder path
...
for i in range(1, 13):  # Assuming images are named ai1.jpg, ai2.jpg, ..., ai30.jpg
    image_path = os.path.join(folder_path, f"real{i}.png")  # Replace .jpg with the correct extension if needed
    # Read the image in grayscale mode
    image = cv2.imread(image_path, cv2.IMREAD_GRAYSCALE)
    
    if image is None:
        print(f"Image real{i} could not be loaded. Skipping...")
        continue
    ...
    print(f"Image real{i}: Noise Score = {noise_score}")
